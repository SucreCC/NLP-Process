...
class Config(object):
    def __init__(self, dataset):
        ...
        # 训练集数据文件的路径
        self.train_path = dataset + '/others/data/THUCNews/train.txt'
        # 验证集数据文件的路径
        self.dev_path = dataset + '/others/data/THUCNews/dev.txt'
        # 测试集数据文件的路径
        self.test_path = dataset + '/others/data/THUCNews/test.txt'
